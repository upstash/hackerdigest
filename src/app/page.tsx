  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-[#0B0A0A] p-4 text-[#FBFBFB] sm:p-24">
      <div className="max-w-[1200px]">
        ...
        <section>
          <h2 className="mb-8 text-2xl font-bold tracking-tight sm:text-4xl">News</h2>
          <div className="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
            {articles.map((article, index) => (
              <div
                key={index}
                className="flex flex-col rounded-2xl border border-gray-900 bg-[#0c0d0ccc] p-4 sm:p-8"
              >
                ...
                <div className="mt-auto flex items-center justify-between">
                  <div className="font-medium text-[#00a372]">
                    <p>
                      Author: <span className="text-[#FBFBFB]">{article?.author}</span>
                    </p>
                    <p className="">
                      Num of comments:{" "}
                      <span className=" text-[#FBFBFB]">{article?.numOfComments}</span>
                    </p>
                    <p>
                      Score: <span className="text-[#FBFBFB]">{article?.score}</span>
                    </p>
                  </div>
        ...
        <footer className="mt-10 flex w-full items-center justify-center gap-3">
          <span className="font-bold">Powered by</span>
          <svg height="30" viewBox="0 0 1631 472" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
